...
export const LINKS = {
  FB: 'https://www.facebook.com/profile.php?id=100078756230778',
  WEBSITE: 'https://dedevtruong.com',
};
...
export const ROUTES = {
  ...
  FLASHCARD: '/flashcard',
  LUCKCLOVER_DICTIONARY: '/luckclover-dictionary',
  ...
  CHALLENGES: {
    HOME: '/challenges',
    CORRECT_WORD: '/challenges/correct-word',
    ...
    SPEAK_WORD_MATCHING: '/challenges/speak-word-match',
