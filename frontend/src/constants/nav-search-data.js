...
const NAV_SEARCH_DATA = [
  ...
  {
    title: 'từ điển Luckclover',
    searchKey:
      'danh sách từ phân loại cấp độ vocabulary dictionary level type list Luckclover',
  ...
  {
    title: 'thử thách',
    searchKey: 'thử thách exam practice ôn tập luyện tập test exams',
    to: ROUTES.CHALLENGES,
  },
  {
    title: 'thử thách hãy chọn từ đúng',
    searchKey: 'correct word',
    to: ROUTES.CHALLENGES.CORRECT_WORD,
  },
  {
    title: 'thử thách hãy chọn từ đúng nâng cao',
    searchKey: 'correct word advance synonyms antonyms',
    to: ROUTES.CHALLENGES.CORRECT_WORD_ADV,
  },
  {
    title: 'đóng góp',
