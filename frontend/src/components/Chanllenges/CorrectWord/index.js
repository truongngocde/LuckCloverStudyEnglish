import WrongIcon from '@mui/icons-material/WrongLocation';
import RightIcon from '@mui/icons-material/Check';
import logoChanllenges from '../../../assets/icons/challenges/correct-word.png';
...
function CorrectWord({ list }) {
  ...
  return (
    <div className="flex-center-col h-100vh container">
      <div className={`${classes.root} container chanllenges-box`}>
        {/* title */}
        <div className="chanllenges-title">
          <imgage src={logoChanllenges} alt="chanllenges photo" />
